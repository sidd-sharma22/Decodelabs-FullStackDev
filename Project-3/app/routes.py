...
## Get All Tasks
@router.get("/tasks", response_model=list[schemas.TaskResponse], status_code=200)
def get_tasks(db: Session = Depends(get_db)):
    return crud.get_tasks(db)


## Get One Task
@router.get("/tasks/{task_id}", response_model=schemas.TaskResponse, status_code=200)
...
## Update Task
@router.put("/tasks/{task_id}", response_model=schemas.TaskResponse, status_code=202)
